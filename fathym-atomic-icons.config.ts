...
export const curIconSetConfig: IconSetConfig = {
  IconMap: {
    "chevron-right": "https://api.iconify.design/material-symbols:chevron-right-rounded.svg",
    "chevron-down": "https://api.iconify.design/mdi:chevron-down.svg",
    "emulated-device": "https://api.iconify.design/material-symbols:android-find-my-device-outline.svg",
    "connected-devices": "https://api.iconify.design/material-symbols:cast-connected-outline.svg",
    "device-telemetry": "https://api.iconify.design/material-symbols:query-stats.svg",
